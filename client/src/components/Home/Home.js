...
function Home() {
    ...
    return (
        <div className='flex flex-col w-full items-center'>
            <div className='flex fixed w-full space-x-8 items-center justify-start bg-slate-50 z-10  p-2 border-b-2 shadow'>
            ...
            <div className='container w-full h-full justify-center'>
                <div id='recently-created' className='flex flex-col h-full mt-16'>
                    <div className='flex w-full justify-start p-2'>
                        <p className='w-full text-2xl text-start text-stone-600 font-medium lg:text-4xl'>
                            Recently Created
                        </p>
                        <div className='flex w-1/3 space-x-2 items-end justify-center'>
                            <div className='w-32 h-[0.62px] bg-stone-200 rounded-full mb-2' />
                            <p className='text-sm w-full text-slate-600'>View all</p>
                        </div>
                    </div>
                ...
                {/* COMPLETED */}
                <div id='recently-created' className='flex flex-col h-full mt-4'>
                    <div className='flex w-full justify-start p-2'>
                        <p className='w-full text-2xl text-start text-stone-600 font-medium lg:text-4xl'>
                            Recently Completed
                        </p>
                    ...
                    <div className='grid grid-cols-1 w-full h-full justify-center items-center gap-2 z-0 p-2'>
                        {recents.map((recent, i) => (
                            <div className='flex flex-col justify-center items-center rounded-xl border-2 border-stone-50 relative h-full'>
                                ...
                                <div className='flex flex-col w-full h-full justify-end p-2 z-50'>
                                    <div className='flex gap-1 w-full'>
                                        <div className='flex justify-center items-center'>
                                            <div className=' bg-slate-800/70 rounded-full px-1'>
                                                <p className='text-end text-[12px] text-stone-50 font-medium p-1'>{recent.checkpoints.length} Waypoints</p>
