...
export default function CreateMap() {
    ...
    return (
        ...
        >
            ...
            <div id='HUD' className='flex flex-col space-y-32 w-full justify-center items-center absolute bottom-12' >
                <div className='flex flex-col space-y-2 items-center  p-3 rounded-xl'>
                    <div
                        className='flex flex-col w-full items-center'
                    >
            ...
            {showIntro && (
                <div id='intro' className='flex w-full justify-center items-center absolute h-full z-100 bg-black/80' >
                    <div className='flex justify-center items-center h-full'>
                        <div className='flex flex-col w-5/6 pb-4 space-y-4 justify-center items-center absolute bg-slate-200  rounded-xl border-2 shadow'>
                            <img src={demo} className='object-contain p-1 rounded-xl flex h-full' alt='trail' />
                            <div className='flex flex-col w-full justify-center items-center space-y-1 p-2'>
                                <p className='flex w-full justify-center items-center text-2xl text-center font-medium'>
                                    Welcome to Athleague!
                                </p>
                                <p className='flex w-full justify-center items-center text-md text-center font-normal'>
                                    Create custom activity courses to establish easy goals for improving fitness.
                                </p>
                            </div>
                            <div className='bg-blue-500 px-4 rounded-md text-xl text-slate-100 p-1'
                                onClick={() => {
                                    console.log('clicked')
